                ...
                <div class="md-layout-item md-size-100 md-layout md-gutter">
                    <div class="md-layout-item">
                        ...
                        @md-selected="getSelectedSubject">
                            ...
                            <span class="md-error" v-if="!$v.selectedSubject.required">Field is required.</span>
                        </md-autocomplete>
                    </div>
                </div>
                ...
                <div class="md-layout-item md-size-100 md-layout md-gutter md-alignment-center-space-between">
                    ...
                    <div class="md-layout-item md-size-35 md-xsmall-size-100 md-layout md-gutter">
                        ...
                        class="has-esc-accent">
                            ...
                            <span class="md-error" v-if="!$v.subjFG.minValue">Accepts from `1.00`.</span>
                            <span class="md-error" v-if="!$v.subjFG.maxValue">Accepts up to `5.00`.</span>
                        </md-field>
                    </div>
                </div>
  ...
  methods: {
    ...
    getSelectedSubject() {
      const selectedSubjDetail =  this.subjectList.find(
          (obj) => obj.desc === this.selectedSubject
      );

      this.selectedSubjUnit = selectedSubjDetail.unit
      this.selectedSubjCode = selectedSubjDetail.code
     }
