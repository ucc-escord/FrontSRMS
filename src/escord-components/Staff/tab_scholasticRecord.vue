            ...
            <div class="md-layout-item md-size-100 md-layout md-gutter md-alignment-center-center">
                <md-button
                  ...
                  class="md-simple md-esc-darkgrey md-dense">
                    <span v-if="selectorShown" class="md-body-2 title _close">CLOSE SELECTOR</span>
                    <span v-else class="md-body-2 title _open">CLICK TO SELECT CLASS</span>
                </md-button>
            </div>

            <!-- SELECTOR -->
            <div v-if="selectorShown" class="md-layout-item md-size-100 md-layout md-gutter md-alignment-center-center">
