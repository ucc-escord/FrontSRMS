                  ...
                  <div class="md-layout-item md-layout md-gutter md-alignment-center-space-between">
                    ...
                    <div class="md-layout-item md-size-100 md-layout md-gutter">
                      ...
                      :class="getValidationClass('password')">
                        ...
                        <span class="md-error" v-else-if="!$v.student_createNewPass.password.containsUpperCase">Must contain at least one uppercase letter.</span>
                        <span class="md-error" v-else-if="!$v.student_createNewPass.password.containsLowerCase">Must contain at least one lowercase letter.</span>
                        <span class="md-error" v-else-if="!$v.student_createNewPass.password.containsNumber">Must contain at least one number.</span>
                        <span class="md-error" v-else-if="!$v.student_createNewPass.password.containsSpecial">Must contain at least one special character [#?!@$%^&*-].</span>
                      </md-field>
